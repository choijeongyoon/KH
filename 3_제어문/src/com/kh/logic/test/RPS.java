...
public class RPS {
	...
	public void test1() {
		...
		// 현재 주소값을 비교하는 '=='이 아닌 '.equals(비교값)' 메소드를 써야한다.
		...
		if ( player.equals( computer )) {
			...
			System.out.println("잘못 입력하셨습니다 ㅠ.ㅠ ");
		}
	}
	...
	public void test2() {
		...
		// 2) Random.nextInt() : 0부터 지정한 수 까지의 임의의 수를 추출
